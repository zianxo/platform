...
func InitSchema(ctx context.Context) error {
	...
	defaultUserSQL := `
		...
		VALUES ('admin@example.com', 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN')
		ON CONFLICT (email) DO UPDATE SET role = 'ADMIN', username = 'admin';
	`
